<div class="items-center justify-center h-full flex-it">
	<div class="text-4xl font-bold text-white">Glider - Create Account</div>
	<div class="w-full p-10 mt-10 bg-white flex-it h-100 xs:w-100 rounded-2xl">
		<div class="flex-it">
			<form class="flex-it">
